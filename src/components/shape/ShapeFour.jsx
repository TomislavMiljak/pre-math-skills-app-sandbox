...
function ShapeFour() {
 ...
 /*  function handleClickCorrect(){
  ...
  return (
    <>
    <div className="shapeFourContainer">
        ...
        <div className='shape-container-four'>
          
        <div className="shape-four-straight-lined"  onClick={handleClickCorrect} /* onClick={() => alert("SORRY, WRONG ANSWER :)")} */ >
        {isClickedCorrect && userHasClicked && <img src={smile} style={{width: "30px", height: "30px", border: "2px solid green", borderRadius: "50%"}}/>}
        </div>
        <div className="shape-four-rounded" onClick={handleClickWrongTwo} /* onClick={() => alert("CORRECT ANSWER! WELL DONE! :)")} */ >
