...
function ShapeOne() {
 ...
 /*  function handleClickCorrect(){
  ...
  return (
    <>
    <div className="shapeOneContainer">
        ...
        <div className='shape-container-one'>
          
        <div className="shape-one-straight-lined"  onClick={handleClickWrongTwo} /* onClick={() => alert("SORRY, WRONG ANSWER :)")} */ >
        {!isClickedCorrectTwo && userHasClickedTwo && <img src={sad} style={{width: "30px", height: "30px", border: "2px solid red", borderRadius: "50%"}}/>}
        </div>
        <div className="shape-one-rounded" onClick={handleClickCorrect} /* onClick={() => alert("CORRECT ANSWER! WELL DONE! :)")} */ >
