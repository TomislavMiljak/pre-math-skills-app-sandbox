...
function DetailsFour() {
 ...
 /*  function handleClickCorrect(){
  ...
  return (
    <>
    <div className="detailsFourContainer">
        ...
        <div className='details-container-four'>
          
        <div className="containing-identical-four"  onClick={handleClickWrongTwo} /* onClick={() => alert("SORRY, WRONG ANSWER :)")} */ >
        ...
        <div className='div-container-four'>
        <div>X</div>
        <div>X</div>
        <div>X</div>
        <div>X</div>
        ...
        <div className="containing-odd-four" onClick={handleClickCorrect} /* onClick={() => alert("CORRECT ANSWER! WELL DONE! :)")} */ >
