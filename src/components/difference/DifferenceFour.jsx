...
function DifferenceFour() {
 ...
 /*  function handleClickCorrect(){
  ...
  return (
    <>
    <div className="differenceFourContainer">
        ...
        <div className='difference-container-four'>
          
        <div className="diff-four-rounded-short"  onClick={handleClickWrongOne} /* onClick={() => alert("SORRY, WRONG ANSWER :)")} */ >
        {!isClickedCorrectOne && userHasClickedOne && <img src={sad} style={{width: "30px", height: "30px", border: "2px solid red", borderRadius: "50%"}}/>}
        </div>
        <div className="diff-four-rounded-long"  onClick={handleClickCorrect} /* onClick={() => alert("SORRY, WRONG ANSWER :)")} */ >
        {isClickedCorrect && userHasClicked && <img src={smile} style={{width: "30px", height: "30px", border: "2px solid green", borderRadius: "50%"}}/>}
        </div>
        <div className="diff-four-rounded-short" onClick={handleClickWrongTwo} /* onClick={() => alert("CORRECT ANSWER! WELL DONE! :)")} */ >
        {!isClickedCorrectTwo && userHasClickedTwo && <img src={sad} style={{width: "30px", height: "30px", border: "2px solid red", borderRadius: "50%"}}/>}
        </div>
        <div className="diff-four-rounded-short"  onClick={handleClickWrongThree} /* onClick={() => alert("SORRY, WRONG ANSWER :)")} */ >
