...
function DifferenceThree() {
 ...
 /*  function handleClickCorrect(){
  ...
  return (
    <>
    <div className="differenceThreeContainer">
        ...
        <div className='difference-container-three'>
          
        <div className="diff-three-rounded"  onClick={handleClickCorrect} /* onClick={() => alert("SORRY, WRONG ANSWER :)")} */ >
        {isClickedCorrect && userHasClicked && <img src={smile} style={{width: "30px", height: "30px", border: "2px solid green", borderRadius: "50%"}}/>}
        </div>
        <div className="diff-three-straight-lined"  onClick={handleClickWrongOne} /* onClick={() => alert("SORRY, WRONG ANSWER :)")} */ >
        {!isClickedCorrectOne && userHasClickedOne && <img src={sad} style={{width: "30px", height: "30px", border: "2px solid red", borderRadius: "50%"}}/>}
        </div>
        <div className="diff-three-straight-lined" onClick={handleClickWrongTwo} /* onClick={() => alert("CORRECT ANSWER! WELL DONE! :)")} */ >
        {!isClickedCorrectTwo && userHasClickedTwo && <img src={sad} style={{width: "30px", height: "30px", border: "2px solid red", borderRadius: "50%"}}/>}
        </div>
        <div className="diff-three-straight-lined"  onClick={handleClickWrongThree} /* onClick={() => alert("SORRY, WRONG ANSWER :)")} */ >
